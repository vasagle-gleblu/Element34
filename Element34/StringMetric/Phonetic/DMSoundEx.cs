...
{
    public class DMSoundEx : IStringEncoder, IStringComparison
    {
    ...
    public class DaitchMokotoffSoundEx
    {
        ...
        public object Encode(object obj)
        {
            ...
            {
                throw new Exception("Parameter supplied to DaitchMokotoffSoundex encode is not of type string");
            }
