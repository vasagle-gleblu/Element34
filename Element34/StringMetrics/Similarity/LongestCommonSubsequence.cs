...
namespace Element34.StringMetrics.Similarity
{
    ...
    /// A longest common subsequence is the longest subsequence common to all sequences in a set 
    /// of sequences.  It differs from the longest common substring: unlike substrings, subsequences 
    /// are not required to occupy consecutive positions within the original sequences.
    /// 
    /// <a href="https://en.wikipedia.org/wiki/Longest_common_subsequence" />
    /// </summary>
