...
namespace Element34.StringMetrics.Similarity
{
    ...
    class DamerauLevenshteinMetric : StringMetric<int?>
    {
        /// <summary>
        ...
        /// </returns>
        public int? Compute(string source, string target, bool ignoreCase)
        {
        ...
        public override int? Compute(char[] a, char[] b)
        {
