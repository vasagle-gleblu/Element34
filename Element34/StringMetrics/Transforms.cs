...
namespace Element34.StringMetrics
{
    ...
    {
        public static string Filter(this char[] ca, Func<char, bool> f)
        {
            return new string(ca.Where(c => f(c)).ToArray());
        }

        public static string FilterNot(this char[] ca, Func<char, bool> f)
        {
            return new string(ca.Where(c => !f(c)).ToArray());
        }
    }
    ...
    {
        public static Func<char[], string> FilterAlpha => ca => ca.Filter(c =>
        {
            var ci = (int)c;
            return LowercaseAlpha.IsSuperset(c) || UppercaseAlpha.IsSuperset(c);
        });

        public static Func<char[], string> FilterNotAlpha => ca => ca.FilterNot(c =>
        {
            var ci = (int)c;
            return LowercaseAlpha.IsSuperset(c) || UppercaseAlpha.IsSuperset(c);
        });

        public static Func<char[], string> FilterAlphaNumeric => ca => ca.Filter(c =>
        {
            var ci = (int)c;
            return LowercaseAlpha.IsSuperset(c) || UppercaseAlpha.IsSuperset(c) || char.IsDigit(c);
        });

        public static Func<char[], string> FilterNotAlphaNumeric => ca => ca.FilterNot(c =>
        {
            var ci = (int)c;
            return LowercaseAlpha.IsSuperset(c) || UppercaseAlpha.IsSuperset(c) || char.IsDigit(c);
        });

        public static Func<char[], string> FilterAscii => ca => ca.Filter(c => c <= 127);
        public static Func<char[], string> FilterNotAscii => ca => ca.FilterNot(c => c <= 127);
        public static Func<char[], string> FilterExtendedAscii => ca => ca.Filter(c => c >= 128 && c <= 255);
        public static Func<char[], string> FilterNotExtendedAscii => ca => ca.FilterNot(c => c >= 128 && c <= 255);
        public static Func<char[], string> FilterLatin => ca => ca.Filter(c => c <= 591);
        public static Func<char[], string> FilterNotLatin => ca => ca.FilterNot(c => c <= 591);
        public static Func<char[], string> FilterLowerCase => ca => new string(ca).ToLowerInvariant();
        public static Func<char[], string> FilterNotLowerCase => ca => new string(ca).ToUpperInvariant();
        public static Func<char[], string> FilterNumeric => ca => ca.Filter(c => char.IsDigit(c));
        public static Func<char[], string> FilterNotNumeric => ca => ca.FilterNot(c => char.IsDigit(c));
        public static Func<char[], string> FilterUpperCase => ca => new string(ca).ToUpperInvariant();
        public static Func<char[], string> FilterNotUpperCase => ca => new string(ca).ToLowerInvariant();
        public static Func<char[], string> IgnoreAlphaCase => ca => new string(ca).ToLowerInvariant();


        public static char[] FoldToASCII(char[] input)
        {
